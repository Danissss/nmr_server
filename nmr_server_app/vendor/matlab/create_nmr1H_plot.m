...
% information about plot_1d function in plot_1d.m
% ax.length() = spectrum.length()
% figure out the algorithm of plot, plot on web
% create customized plot_1d.m on server 
%plot(ax,spectrum,varargin{:}); axis tight; box on; grid on;

[ax,spectrum] = plot_1d(spin_system,real(spectrum),parameters);
